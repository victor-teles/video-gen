...
# Production Deployment Script for Editur AI Backend with Full AI Models
# This version includes all AI dependencies and models for production use
...
echo "🚀 Production Deploy - Editur AI Backend (Full AI Models)"
echo "=========================================================="
...
# Request spot instance with 50GB storage
...
log_success "Production spot instance requested: $SPOT_REQUEST_ID"
...
echo "   Monthly: ~\$15-20 (with full AI capabilities)"
